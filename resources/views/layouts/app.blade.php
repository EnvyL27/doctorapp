            ...
            <div class="account">
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                        ...
                        <a class="dropdown-item" href="#">
                            <i class="fas fa-people-arrows fa-fw mr-2 text-gray-400"></i>
                            Switch Account
                        </a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center mb-4">
                        <h6 class="mb-0 mr-2 text-gray-800 font-weight-bold">@yield('breadcrumb1')</h6>
                        <i class="fas fa-home mr-2"></i>
                        <i class="fas fa-circle mr-2" style="font-size: 5px;"></i>
                        <h6 class="mb-0 text-gray-800 mr-2 font-weight-light">@yield('breadcrumb2')</h6>
                        <i class="fas fa-circle mr-2" style="font-size: 5px;"></i>
                        <h6 class="mb-0 text-gray-800 font-weight-light">@yield('breadcrumb3')</h6>
                    </div>
